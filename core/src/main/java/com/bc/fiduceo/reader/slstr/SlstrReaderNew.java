...
public class SlstrReaderNew extends SNAP_Reader {
    ...
    public void open(File file) throws IOException {
        ...
        File manifestFile = productDir.getFile("xfdumanifest.xml");


        if (ReaderUtils.isCompressed(file)) {

            //this.productDir = readerContext.createDirInTempDir(fileName + millis);
//            zipFile = new ZipFile(file);
//            try {
//                ZipUtils.unzip(file.toPath(), this.productDir.toPath(), true);
...
//            }
    ...
    public Array readScaled(int centerX, int centerY, Interval interval, String variableName) throws IOException {
        ...
        final RasterDataNode dataNode = getRasterDataNode(variableName);
        final double noDataValue = SlstrReaderNew.getGeophysicalNoDataValue(dataNode);
