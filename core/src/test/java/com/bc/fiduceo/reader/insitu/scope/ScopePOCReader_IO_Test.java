...
public class ScopePOCReader_IO_Test {

    private ScopePOCReader reader;
    ...
    public void testReadAcquisitionInfo() throws IOException {
        final File testFile = getPOCTestFile();
    ...
    public void testGetVariables() throws Exception {
        ...
        try {
            ...
            boolean hasPOC = false, hasDepth = false;
            for (Variable var : variables) {
                ...
                if ("POC".equals(name)) hasPOC = true;
            ...
            assertTrue("Should have POC variable", hasPOC);
    ...
    @Test
    public void testReadScaled_POC() throws Exception {
        final File testFile = getPOCTestFile();

        try {
            reader.open(testFile);
            final Array array = reader.readScaled(0, 0, new Interval(1, 1), "POC");

            assertNotNull("Should read POC variable", array);
            assertArrayEquals(new int[]{1, 1}, array.getShape());
        } finally {
            reader.close();
        }
    ...
    public void testExtractYearMonthDayFromFilename() {
        int[] ymd = reader.extractYearMonthDayFromFilename("SCOPE_WP26_POC_1997_2020.txt");
    ...
    public void testParseLine_ValidLine() {
        ...
        final PocRecord record = reader.parseLine(validLine);
        ...
        assertEquals(12.3f, record.poc, 0.001f);
    ...
    public void testParseLine_InvalidLineTooFewTokens() {
        ...
        final PocRecord record = reader.parseLine(invalidLine);
